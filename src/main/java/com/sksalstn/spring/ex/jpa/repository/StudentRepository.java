package com.sksalstn.spring.ex.jpa.repository;
...
public interface StudentRepository extends JpaRepository<Student, Integer>  {
	...
	// id가 특정 값들 사이에 대응되는 데이터를 조회 id 기준으로 내리차순
	// id BETWEEN 1 AND 2
	...
	public List<Student> findByDreamJpbQuery(@Param("dreamJob") String dreamJob);
