package com.sksalstn.spring.ex.jpa;
...
import com.sksalstn.spring.ex.jpa.domain.Student;
import com.sksalstn.spring.ex.jpa.repository.StudentRepository;
import com.sksalstn.spring.ex.jpa.service.StudentService;
...
//		List<Student> studentList = studentRepository.findByIdBetweenOrderByIdDesc(1, 2);
		...
		List<Student> studentList = studentRepository.findByDreamJpbQuery("모델");
